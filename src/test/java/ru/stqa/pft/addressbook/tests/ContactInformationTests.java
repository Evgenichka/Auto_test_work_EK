...
public class ContactInformationTests extends TestBase {
    ...
    public void testContactEqualityOnForms() {
        ...
        ContactData contactInfoFromEditForm = appManager.contact().infoFromEditForm(contactList);

        assertThat(contactList.getFirstName(), equalTo(contactInfoFromEditForm.getFirstName()));
        assertThat(contactList.getLastName(), equalTo(contactInfoFromEditForm.getLastName()));
        assertThat(contactList.getAddress(), equalTo(contactInfoFromEditForm.getAddress()));
        assertThat(contactList.getAllEmail(), equalTo(mergeEmails(contactInfoFromEditForm)));
        assertThat(contactList.getAllPhones(), equalTo(mergePhones(contactInfoFromEditForm)));
    }
